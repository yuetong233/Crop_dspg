    ...
    tabPanel(
      ...
      fluidPage(
        ...
        fluidRow(
          ...
          column(6,
                 img(src = "https://raw.githubusercontent.com/yuetong233/Crop_dspg/refs/heads/main/KohlCentre_Vertical_FullColor_RGB%201.jpg", height = "120px", style = "margin-top: 20px; float: right;")
          )
        ),
        ...
        tags$ul(
          tags$li(
            strong("Undergraduate Interns:"), 
            " ",
            tags$a(href = "https://www.linkedin.com/in/maryam-rehmatulla/", target = "_blank", "Maryam Rehmatulla"),
            " and ",
            tags$a(href = "https://www.linkedin.com/in/shlok-kulkarni-5602781b2/", target = "_blank", "Shlok Kulkarni")
          ),
          tags$li(
            strong("Graduate Fellow:"), 
            " ",
            tags$a(href = "https://www.linkedin.com/in/zhang-yuetong-44595887/", target = "_blank", "Yuetong Zhang")
          ),
          tags$li(
        ...
        tags$p(
          "View the project source code and documentation on ",
          tags$a(href = "https://github.com/yuetong233/Crop_dspg", 
                 target = "_blank", 
